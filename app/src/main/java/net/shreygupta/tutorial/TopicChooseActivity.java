...
public class TopicChooseActivity extends AppCompatActivity {
    ...
    private final String [] items = {"History", "Life Cycle", "Orientation", "Log Class", "Event Handling",
            "Toast", "Context", "View & View Group", "Layout Inflator", "Margin", "Padding",
            "Text View", "Edit Text", "Check Box", "Radio Button", "Layouts", "Linear Layout",
            "Relative Layout", "Table Layout", "Grid Layout"};
